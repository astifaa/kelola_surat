...
<div id="content" class="content">
    ...
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header"><i class="fa fa-paper-plane"></i>  <?php echo $judul ?>&nbsp;&nbsp; <small></small></h1>
    <!-- end page-header -->
<div class="row">
    <div class="col-lg-12">
                        ...
                        foreach ($data_surat_keluar as $surat_keluar) {
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                    ...
                                    <a href="' . base_url('home/hapus_surat_keluar/' . $surat_keluar->id_surat) . '" class="btn btn-danger btn-sm" onclick="return confirm("Apakah Anda yakin ingin menghapus data ini?")">Hapus</a>
                                </td>
                            </tr>
                            ';
                        }
