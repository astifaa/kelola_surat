...
<div id="content" class="content">
    ...
    <ol class="breadcrumb float-xl-right">
        <button class="btn btn-info" data-toggle="modal" data-target="#tambah_surat_masuk">
                        <i class="fas fa-plus fa-fw"></i> Tambah <?php echo $judul ?>
                    </button>
    </ol>
    <!-- end breadcrumb -->
    <!-- begin page-header -->
    <h1 class="page-header"><i class="fa fa-inbox"></i> Surat Masuk <small></small></h1>
    <!-- end page-header -->
    <div class="row">
        <div class="col-lg-12" >
                        ...
                        <tbody>
                            ...
                            if (isset($data_surat_masuk)) {
                                foreach ($data_surat_masuk as $surat_masuk) {
                                    ...
                                    <a title="Lihat isi surat" href="' . base_url('/uploads/' . $surat_masuk->file_surat) . '" class="btn btn-sm btn-info"><i class="fas fa-file fa-fw"></i></a>
                                    <button title="Ubah isi surat" class="btn btn-sm btn-success" data-toggle="modal" data-target="#ubah_surat_masuk" onclick="ubah_surat(' . $surat_masuk->id_surat . ')"><i class="fas fa-cog fa-fw"></i></button>
                                    <button title="Ubah file surat masuk" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#ubah_file_surat_masuk" onclick="ubah_surat(' . $surat_masuk->id_surat . ')"><i class="fas fa-edit fa-fw"></i></button>
                                    <a title="Kirim Disposisi" href="' . base_url('home/disposisi/' . $surat_masuk->id_surat) . '" class="btn btn-sm btn-primary"><i class="fas fa-share-square fa-fw"></i></a>
                                    <a title="Hapus Surat Masuk" href="' . base_url('home/hapus_surat_masuk/' . $surat_masuk->id_surat) . '" class="btn btn-sm btn-danger"><i class="fas fa-trash fa-fw"></i></a>
                                    </td>
                                    </tr>
                                    ';
                                }
